...
export default function DomainLookup() {
  ...
  const [activeTab, setActiveTab] = useState<"general" | "dns" | "whois">(
    "general",
  );
    ...
    try {
      ...
      const records: DNSRecord[] = Array.from({ length: recordCount }, () => {
        ...
        switch (type) {
          case "A":
            ...
            break;
          case "AAAA":
            value = "2001:0db8:85a3:0000:0000:8a2e:0370:7334".replace(
              /0000/g,
              () =>
      ...
      const whois = {
        ...
        nameservers: Array.from(
          { length: 2 },
          (_, i) =>
            `ns${i + 1}.${["cloudflare.com", "google.com", "amazonaws.com"][Math.floor(Math.random() * 3)]}`,
        ),
      };
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              onClick={() => {
                ...
                const blob = new Blob([JSON.stringify(domainInfo, null, 2)], {
                ...
                // Track download
                trackToolUsage("DomainLookup", "export_results", {
            ...
            <div>
              ...
              <div className="mb-4 bg-gray-50 p-3 rounded-md">
                ...
                <div className="mb-2">
                  ...
                  {Array.from(
                    new Set(domainInfo.records.map((r) => r.type)),
                  ).join(", ")}
                </div>
                <div>
                  ...
                  <tbody>
                    {domainInfo.records.map((record, index) => (
                      ...
                      >
                        ...
                        <td className="py-2 px-4">{record.ttl} seconds</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          {activeTab === "whois" && (
            <div>
              ...
              <div className="mt-4 p-3 bg-blue-50 text-blue-800 rounded-md text-sm">
                <p>
                  <strong>Note:</strong> This is a demonstration with simulated
                  WHOIS data. For complete and accurate WHOIS information,
                  please use official WHOIS services.
                </p>
              </div>
            </div>
          )}
