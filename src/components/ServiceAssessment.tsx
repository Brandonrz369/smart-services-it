...
export default function ServiceAssessment() {
  ...
  const assessment: Assessment = {
    ...
    description:
      "Answer a few questions to get personalized IT recommendations for your business or home",
    ...
    questions: [
        ...
        options: [
          {
            ...
            label: "Business",
            description:
              "Services for companies, organizations, or self-employed",
          },
          {
            value: "home",
            label: "Personal/Home",
            description: "Services for personal devices or home networks",
          },
        ],
        nextQuestion: {
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "msp",
            label: "Yes, we use another managed service provider",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "planning",
            label: "Planning - Researching options for the future",
          },
        ],
  ...
  const getRelevantQuestions = () => {
    return assessment.questions.filter((q) => {
      ...
      const { questionId, answers } = q.condition as {
        questionId: string;
        answers: string[];
      };
  ...
  const handleAnswer = (answer: string | string[]) => {
    ...
    if (typeof currentQuestion!.nextQuestion === "string") {
      ...
      typeof currentQuestion!.nextQuestion === "object" &&
  ...
  const generateRecommendations = () => {
    ...
    if (
      isString(answers.business_type) &&
      answers.business_type === "business"
    ) {
      ...
      if (isString(answers.business_size)) {
        if (["micro", "solo"].includes(answers.business_size)) {
          recommendations.push({
            ...
            description:
              "Affordable monthly support designed specifically for small businesses and freelancers.",
            icon: "💼",
          });
          ...
          recommendations.push({
            ...
            description:
              "Complete IT management with 24/7 monitoring, support, and strategic planning.",
            icon: "🏢",
          });
        }
      }
      ...
      if (isStringArray(answers.top_concerns)) {
        if (answers.top_concerns.includes("security")) {
          recommendations.push({
            ...
            description:
              "Multi-layered security with advanced threat protection, employee training, and regular security assessments.",
            icon: "🔒",
          });
        }
        ...
        if (answers.top_concerns.includes("cloud")) {
          recommendations.push({
            ...
            description:
              "Seamless transition to cloud services with ongoing management and optimization.",
            icon: "☁️",
          });
        }
        ...
        if (answers.top_concerns.includes("remote")) {
          recommendations.push({
            ...
            description:
              "Secure, reliable remote access solutions with VPN, collaboration tools, and cloud-based services.",
            icon: "🏠",
          });
        }
      }
      ...
      if (isStringArray(answers.device_type)) {
        if (answers.device_type.includes("laptop")) {
          recommendations.push({
            ...
            description:
              "Comprehensive system cleaning, updates, and performance optimization.",
            icon: "💻",
          });
        }
        ...
        if (answers.device_type.includes("network")) {
          recommendations.push({
            ...
            description:
              "WiFi optimization, security hardening, and proper network configuration.",
            icon: "🔌",
          });
        }
        ...
        if (answers.device_type.includes("smart_home")) {
          recommendations.push({
            ...
            description:
              "Setup, troubleshooting, and security for your connected home devices.",
            icon: "🏠",
          });
        }
      }
      ...
      if (isStringArray(answers.home_issue)) {
        if (answers.home_issue.includes("virus")) {
          recommendations.push({
            ...
            description:
              "Complete malware removal, system cleaning, and ongoing protection setup.",
            icon: "🦠",
          });
        }
        ...
        if (answers.home_issue.includes("data")) {
          recommendations.push({
            ...
            description:
              "Professional recovery of lost or damaged files with secure backup solutions.",
            icon: "💾",
          });
        }
      }
    ...
    if (
      isString(answers.urgency) &&
      ["emergency", "urgent"].includes(answers.urgency)
    ) {
      recommendations.push({
    ...
    if (recommendations.length === 0) {
      recommendations.push({
        ...
        description:
          "Schedule a call with our experts to discuss your specific needs and create a custom solution.",
        icon: "👨‍💻",
      });
    }
      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">
            Your Personalized IT Recommendations
          </h3>
          <p className="text-gray-600 max-w-lg mx-auto">
            Based on your needs, we&apos;ve prepared these custom
            recommendations. A member of our team will contact you shortly to
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ol className="space-y-2 text-gray-600">
            <li className="flex items-start">
              <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-blue-600 text-white text-sm font-medium mr-3">
                1
              </span>
            ...
            <li className="flex items-start">
              ...
              <span>
                We&apos;ll contact you within 1 business day (or immediately for
                urgent needs)
              </span>
            </li>
            <li className="flex items-start">
              ...
              <span>
                You&apos;ll receive a detailed proposal with pricing and options
              </span>
            </li>
          </ol>
        </div>
