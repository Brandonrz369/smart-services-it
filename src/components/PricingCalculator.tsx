  ...
  additionalServices: [
    {
      ...
      pricePerUser: 10,
      description:
        "Enhanced security with threat hunting, dark web monitoring, and security awareness training.",
    },
    {
      ...
      pricePerUser: 5,
      description:
        "Management and optimization of Microsoft 365, Azure, or other cloud platforms.",
    },
    {
      ...
      pricePerUser: 8,
      description:
        "Secure and manage phones, tablets, and laptops with remote wipe capabilities.",
    },
    {
      ...
      pricePerUser: 15,
      description:
        "Cloud-based business phone system with mobile integration and advanced features.",
    },
  ],
  onDemandServices: [
    {
      ...
      unit: "per hour",
      description:
        "Regular business hours support for hardware, software, and network issues.",
    },
    {
      ...
      unit: "per hour",
      description:
        "Expedited response for critical issues affecting business operations.",
    },
    {
      ...
      unit: "per hour",
      description:
        "Support outside regular business hours including evenings and weekends.",
    },
    {
      ...
      unit: "per hour",
      description:
        "Implementation of new technology solutions or infrastructure upgrades.",
    },
  ],
};
...
export default function PricingCalculator() {
    ...
    try {
      ...
      formObject["plan"] =
        calculatorType === "managed"
          ? pricingData.managedServices[selectedPlan].name
          : "On-Demand";
      ...
      if (calculatorType === "managed") {
        ...
        if (additionalServices.length > 0) {
          const servicesNames = additionalServices.map(
            (i) => pricingData.additionalServices[i].name,
          );
  ...
  const calculatePrice = () => {
    if (calculatorType === "managed") {
      ...
      const basePrice =
        plan.priceMonthly + plan.pricePerUser * Math.max(0, userCount - 1);
        ...
        {quoteSubmitted ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-6">
              Your quote request has been received. One of our IT specialists
            ...
            {calculatorType === "managed" && (
              <div className="bg-blue-50 p-4 rounded-lg mb-6">
                ...
                <div className="mt-2 font-medium text-blue-800">
                  Estimated Total: ${calculatePrice().totalPrice.toFixed(2)}
                  /month
                </div>
              </div>
            )}
                    ...
                    <ul className="space-y-2 text-sm">
                      {plan.features.map((feature, i) => (
                        <li key={i} className="flex items-start">
                          <svg
                            className="w-5 h-5 text-green-500 mr-1.5 flex-shrink-0"
                            viewBox="0 0 20 20"
                            fill="currentColor"
                          >
                            <path
                ...
                <div className="mb-4">
                  ...
                  <div className="flex max-w-xs">
                    ...
                    <span className="ml-3 text-sm text-gray-500 self-center">
                      ${pricingData.managedServices[selectedPlan].pricePerUser}
                      /user after first user
                    </span>
                  </div>
                </div>
              </div>
                    ...
                    >
                      <div className="flex justify-between flex-wrap">
                        ...
                        <span className="text-blue-600 font-medium">
                          +${service.priceMonthly}/mo + ${service.pricePerUser}
                          /user
                        </span>
                      </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 mb-6">
                  ...
                  {additionalServices.length > 0 && (
                    <div className="flex justify-between py-2 border-b border-white/20">
                      ...
                      <span className="font-bold">
                        ${calculatePrice().addonsPrice.toFixed(2)}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex justify-between text-sm text-white/80 pt-1">
                    ...
                    <span>
                      ${calculatePrice().pricePerUser.toFixed(2)}/user/month
                    </span>
                  </div>
                </div>
          ...
          <div>
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-xl mx-auto">
                Our on-demand services can be tailored to your specific needs.
