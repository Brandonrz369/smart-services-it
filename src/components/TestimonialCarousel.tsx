        ...
        {testimonials[current].source && (
          <div className="absolute top-2 right-2">
            ...
            {testimonials[current].source === 'facebook' && (
              <div className="w-8 h-8 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 512 512">
                  <path d="M256 0C114.84 0 0 114.84 0 256C0 397.16 114.84 512 256 512C397.16 512 512 397.16 512 256C512 114.84 397.16 0 256 0Z" fill="#1877F2"/>
                  <path d="M355.6 330.4L367.36 256H296.32V208C296.32 188.32 306.08 169.28 337.28 169.28H370.4V105.28C370.4 105.28 341.76 100 314.56 100C258.24 100 221.44 134.72 221.44 199.36V256H156.64V330.4H221.44V512C234.56 514.72 248.16 516 262.24 516C276.32 516 289.92 514.72 303.04 512V330.4H355.6Z" fill="white"/>
                </svg>
              </div>
            )}
            {testimonials[current].source === 'thumbtack' && (
              <div className="w-8 h-8 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 512 512">
                  ...
                  <path d="M415.47 140.75L371.26 96.53C359.87 85.15 341.15 85.15 329.77 96.53L227.79 198.51L141.13 111.85L119.15 133.83L205.81 220.49L103.83 322.47C92.45 333.85 92.45 352.57 103.83 363.96L148.04 408.17C159.43 419.55 178.15 419.55 189.53 408.17L291.51 306.19L378.17 392.85L400.15 370.87L313.49 284.21L415.47 182.23C426.85 170.85 426.85 152.13 415.47 140.75Z" fill="#009FD9"/>
                </svg>
              </div>
            )}
            {testimonials[current].source === 'nextdoor' && (
              <div className="w-8 h-8 flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 512 512">
                  ...
                  <path d="M142 142H370V370H142V142ZM256 182L182 256L256 330L330 256L256 182Z" fill="white"/>
                </svg>
              </div>
            )}
          </div>
