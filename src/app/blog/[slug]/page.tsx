...
const blogPosts = [
  {
    ...
    relatedPosts: ['windows-11-productivity', 'managed-services-benefits', 'network-troubleshooting']
  },
  {
    ...
    relatedPosts: ['cloud-storage-solutions', 'network-troubleshooting', 'smartphone-battery-tips']
  },
  {
    ...
    relatedPosts: ['securing-your-small-business', 'managed-services-benefits', 'windows-11-productivity']
  },
  {
    ...
    relatedPosts: ['cloud-storage-solutions', 'windows-11-productivity', 'managed-services-benefits']
  },
  {
    ...
    relatedPosts: ['network-troubleshooting', 'windows-11-productivity', 'securing-your-small-business']
  },
  {
    ...
    relatedPosts: ['securing-your-small-business', 'cloud-storage-solutions', 'network-troubleshooting']
  }
];
    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section className="py-16 px-4 md:px-8 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Need Professional IT Support?</h2>
          <p className="text-lg mb-8 text-blue-100 max-w-2xl mx-auto">
            From everyday tech problems to managed IT services, our team of experts is here to help your business succeed.
          </p>
