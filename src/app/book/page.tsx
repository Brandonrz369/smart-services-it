...
export default function BookingPage() {
  ...
  return (
    <div
      className={`min-h-screen bg-white text-foreground font-sans transition-opacity duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}
    >
      {/* Banner */}
              ...
              <FadeIn direction="right">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        <p className="text-gray-700 font-medium">
                          Flexible scheduling that works around your time
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        <p className="text-gray-700 font-medium">
                          Expert technicians qualified to handle any IT issue
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        <p className="text-gray-700 font-medium">
                          Remote or on-site services available
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start">
                ...
                <div className="bg-gray-50 p-6 rounded-xl shadow-md">
                  ...
                  <p className="text-gray-600 mb-4">
                    If you have questions about booking or need immediate
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                ...
                appointment details. Our team will reach out if any additional
                information is needed before your scheduled time.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-2">
              ...
              <p className="text-gray-600">
                Make a list of issues you&apos;re experiencing, have any
                relevant device information ready, and ensure we can access the
                systems that need service.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-2">
              ...
              <p className="text-gray-600">
                Yes, you can reschedule through the link in your confirmation
                email or by calling our office at least 24 hours in advance.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-2">
              ...
              <p className="text-gray-600">
                Yes, many issues can be resolved with remote support. During
                your scheduled time, we&apos;ll guide you through establishing a
                secure remote connection if needed.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-lg mb-6 text-red-100 max-w-2xl mx-auto">
              Don&apos;t wait for a scheduled appointment if you have a critical
              IT emergency.
            </p>
