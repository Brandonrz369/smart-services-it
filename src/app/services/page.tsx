              ...
              <div className="mt-8 flex justify-center">
                <a 
                  ...
                  onClick={() => {
                    ...
                    feedbackEl.textContent = 'Scrolling to contact section';
                    feedbackEl.className = 'fixed top-20 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-4 py-2 rounded-md z-50';
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              onClick={() => {
                // Add visible feedback
                const feedbackEl = document.createElement('div');
                feedbackEl.textContent = 'Calling (213) 349-6790';
                feedbackEl.className = 'fixed top-20 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-4 py-2 rounded-md z-50';
                document.body.appendChild(feedbackEl);
                setTimeout(() => feedbackEl.remove(), 2000);
              }}
