...
const servicesDetail = [
  {
    ...
    pricing: [
      {
        service: "Basic Diagnostic",
        price: "$49",
        description: "Identify issues with your system",
      },
      {
  ...
  },
  {
    ...
    pricing: [
      {
        service: "Basic MSP Plan",
        price: "From $299/mo",
        description: "For businesses with 1-5 employees",
      },
      {
        service: "Standard MSP Plan",
        price: "From $499/mo",
        description: "For businesses with 6-15 employees",
      },
      {
        service: "Premium MSP Plan",
        price: "From $999/mo",
        description: "For businesses with 16-30 employees",
      },
      {
        service: "Enterprise MSP Plan",
        price: "Custom",
        description: "For businesses with 30+ employees",
      },
      {
        service: "On-demand IT Support",
        price: "$125/hr",
        description: "As-needed IT assistance",
      },
    ],
    category: "business",
    longDescription:
    ...
    pricing: [
      {
        ...
        price: "$249",
        description: "Comprehensive evaluation of current setup",
      },
      {
      ...
      {
        service: "Network Security Implementation",
        price: "From $599",
        description: "Firewall and security configuration",
      },
      {
        service: "Wireless Network Setup",
        price: "From $399",
        description: "Enterprise WiFi solutions",
      },
      {
        service: "Cloud Server Migration",
        price: "From $999",
  ...
  },
  {
    ...
    pricing: [
      ...
      },
      {
        ...
        price: "From $99",
        description: "Voice assistants and hub configuration",
      },
      {
        service: "Smart Lighting Installation",
        price: "From $129",
        description: "Connected lighting systems",
      },
      {
        service: "Multi-device Integration",
        price: "From $179",
        description: "Creating seamless smart home ecosystems",
      },
    ],
    category: "residential",
    longDescription:
  ...
  },
  {
    ...
    pricing: [
      ...
      },
      {
        ...
        price: "$999",
        description: "Strategic planning for 1-3 years",
      },
      {
        service: "Vendor Selection",
        price: "From $599",
        description: "Find the right technology partners",
      },
      {
      ...
      {
        service: "IT Budget Planning",
        price: "From $799",
        description: "Optimize technology spending",
      },
    ],
    category: "business",
    longDescription:
  ...
  },
  {
    ...
    pricing: [
      ...
      },
      {
        ...
        price: "From $49",
        description: "Remote setup and configuration",
      },
      {
