...
export default function CaseStudiesPage() {
  ...
  const industries = ['all', ...new Set(caseStudies.map(study => study.industry.toLowerCase()))];
  
  // Filter case studies based on industry and search query
  const filteredCaseStudies = caseStudies.filter(study => {
    const matchesIndustry = industryFilter === 'all' || study.industry.toLowerCase() === industryFilter.toLowerCase();
    const matchesSearch = 
      ...
      <div className="relative py-24 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Real-world technology solutions that helped businesses overcome challenges and achieve growth
          </p>
        </div>
      </div>
      ...
      <section className="py-16 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">
            {industryFilter === 'all' ? 'All Case Studies' : `${industryFilter.charAt(0).toUpperCase() + industryFilter.slice(1)} Industry Solutions`}
          </h2>
          ...
          {filteredCaseStudies.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <button 
                onClick={() => {setIndustryFilter('all'); setSearchQuery('');}}
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-lg">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto text-blue-100">
              Let&apos;s discuss how our IT solutions can address your specific challenges and help your business succeed.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.986.836l.74 4.435a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                Call (213) 349-6790
              </a>
              <a 
