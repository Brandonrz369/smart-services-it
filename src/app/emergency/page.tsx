    ...
    <div className={`min-h-screen bg-background text-foreground font-sans transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="relative py-24 bg-gradient-to-r from-red-700 to-red-500 text-white">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Emergency IT Support</h1>
      ...
      <section className="py-16 px-4 md:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Common Emergency Scenarios</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md">
                <div className="p-6">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-1">Ransomware & Malware Attacks</h3>
                      <p className="text-gray-600">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md">
                <div className="p-6">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-1">Network/Internet Outages</h3>
                      <p className="text-gray-600">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md">
                <div className="p-6">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-1">Server/System Failures</h3>
                      <p className="text-gray-600">
                        Emergency repair of critical system failures affecting business applications. We work quickly to restore services, implement workarounds, and resolve hardware or software issues.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md">
                <div className="p-6">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-1">Data Loss & Recovery</h3>
                      <p className="text-gray-600">
                        Urgent data recovery services for accidental deletions or storage failures. Our specialized tools and processes help retrieve lost data and implement safeguards against future incidents.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Emergency Response SLA</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-xl overflow-hidden shadow-md">
            <table className="min-w-full">
              <thead>
                <tr>
                  <th className="px-6 py-4 bg-gray-100 text-left text-lg font-medium text-gray-800">Service Level</th>
                  <th className="px-6 py-4 bg-gray-100 text-left text-lg font-medium text-gray-800">Response Time</th>
                  <th className="px-6 py-4 bg-gray-100 text-left text-lg font-medium text-gray-800">Availability</th>
                  <th className="px-6 py-4 bg-gray-100 text-left text-lg font-medium text-gray-800">Rate</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 text-md text-gray-900 font-medium">Business Hours Emergency</td>
                  <td className="px-6 py-4 text-md text-gray-800">30 minutes or less</td>
                  <td className="px-6 py-4 text-md text-gray-800">Mon-Fri, 6AM - 6PM<br />Sat, 6AM - 6PM</td>
                  <td className="px-6 py-4 text-md text-gray-800">$225/hour</td>
                </tr>
                <tr className="bg-white">
                  <td className="px-6 py-4 text-md text-gray-900 font-medium">After Hours Emergency</td>
                  <td className="px-6 py-4 text-md text-gray-800">2 hours or less</td>
                  <td className="px-6 py-4 text-md text-gray-800">Evenings, Weekends,<br />and Holidays</td>
                  <td className="px-6 py-4 text-md text-gray-800">$275/hour</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 text-md text-gray-900 font-medium">MSP Clients</td>
                  <td className="px-6 py-4 text-md text-gray-800">Priority response</td>
                  <td className="px-6 py-4 text-md text-gray-800">24/7 depending on plan</td>
                  <td className="px-6 py-4 text-md text-gray-800">Included in service plan</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-16 px-4 md:px-8 bg-red-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            <h2 className="text-3xl font-bold mb-4">Need Emergency IT Support Now?</h2>
            ...
            <p className="mt-8 text-sm text-red-200">
              For non-emergency support, please <Link href="/contact" className="underline hover:text-white">contact us here</Link>.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <div className="space-y-6">
            <FadeIn delay={0.1}>
              <div className="bg-white rounded-xl overflow-hidden shadow-md p-6">
                <h3 className="text-xl font-bold mb-2">What qualifies as an IT emergency?</h3>
                <p className="text-gray-600">
            ...
            <FadeIn delay={0.2}>
              <div className="bg-white rounded-xl overflow-hidden shadow-md p-6">
                <h3 className="text-xl font-bold mb-2">How quickly can you respond to an emergency?</h3>
                <p className="text-gray-600">
            ...
            <FadeIn delay={0.3}>
              <div className="bg-white rounded-xl overflow-hidden shadow-md p-6">
                <h3 className="text-xl font-bold mb-2">What should I do while waiting for emergency support?</h3>
                <p className="text-gray-600">
            ...
            <FadeIn delay={0.4}>
              <div className="bg-white rounded-xl overflow-hidden shadow-md p-6">
                <h3 className="text-xl font-bold mb-2">How are emergency services billed?</h3>
                <p className="text-gray-600">
