                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Please call for appointment before visiting
                      </p>
                    </div>
                  </div>
                ...
                {formStatus === "success" ? (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                    ...
                    <p className="text-green-700 mb-4">
                      Thank you for contacting LB Computer Help. We&apos;ll get
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                    ...
                    <p className="text-red-700 mb-4">
                      ...
                      contact us directly at (213) 349-6790.
                    </p>
                    <button
                      onClick={() => setFormStatus("idle")}
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="computer-services">Computer Services</option> {/* Changed */}
                        <option value="network-support">Network Support</option>
                        <option value="data-solutions">Data Solutions</option> {/* Changed */}
                        <option value="security-cleanup">
                        ...
                        <option value="mobile-assistance">Mobile Device Assistance</option> {/* Added */}
                    ...
                    <div className="flex items-start">
                      ...
                      >
                        I agree to be contacted by LB Computer Help regarding my
                        inquiry.
                      </label>
                    </div>
