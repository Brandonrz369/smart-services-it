...
export default function AdminWebTools() {
  ...
  const [activeTab, setActiveTab] = useState<'seo' | 'security' | 'network' | 'utilities' | 'forms'>('seo');
      ...
      <div className="mb-6 border-b border-gray-200">
        <nav className="flex space-x-8" aria-label="Tabs">
          ...
          <button
            ...
            className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'utilities' 
              ? 'border-blue-500 text-blue-600' 
              : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
          >
            Utilities
          ...
          <button
            ...
            className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'forms' 
              ? 'border-blue-500 text-blue-600' 
              : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
          >
            Form Testing
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Comprehensive SEO analysis tool to identify optimization opportunities and improve search rankings.
            </p>
          </div>
      ...
      {activeTab === 'security' && (
        <div className="bg-white shadow-md rounded-lg overflow-hidden p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Scan for common security vulnerabilities and receive recommendations for hardening your website security.
            </p>
          </div>
      ...
      {activeTab === 'network' && (
        <div className="bg-white shadow-md rounded-lg overflow-hidden p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Advanced network troubleshooting tools for diagnosing connectivity issues and optimizing performance.
            </p>
          </div>
      ...
      {activeTab === 'utilities' && (
        <div className="bg-white shadow-md rounded-lg overflow-hidden p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Collection of useful utilities for website administrators, including image optimization, code validation, and more.
            </p>
          </div>
      ...
      {activeTab === 'forms' && (
        <div className="bg-white shadow-md rounded-lg overflow-hidden p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Advanced tools for testing, debugging, and monitoring form submissions.
            </p>
          </div>
          ...
          <div className="mb-10">
            ...
            <div className="bg-yellow-50 p-4 rounded-lg mb-6">
              <p className="text-gray-700 mb-2">
                Use this debugger to test FormSpree configurations with different submission methods and custom fields.
                Get detailed logs to diagnose issues with your forms.
              </p>
            </div>
            <FormDebugger />
          </div>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            <p className="text-sm">Access specific tools directly with these links:</p>
